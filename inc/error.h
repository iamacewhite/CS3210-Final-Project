...
enum {
	...
	// Paging error code -- only seen in user-level
	E_PAGING	= 16,	// Paging system error

	// Kernel error codes -- keep in sync with list in lib/printfmt.c.
	E_IPC_NOT_SEND	= 17,	// Attempt to receive at env that has no senders
	E_SWAP_SPACE_FULL	= 18,	// No more swap space
